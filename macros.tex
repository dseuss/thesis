...
\Crefname{AlgoLine}{Line}{Algorithms}
...
\newcommand{\ind}[1]{^{(#1)}}
\newcommand{\Nset}{[N]}
\newcommand{\NsetSub}[1]{\Nset_{\setminus {#1}}}

\newcommand{\delI}{\delta_\mathrm{I}}
\newcommand{\delB}{\delta_\mathrm{B}}
\newcommand{\delG}{\delta_\mathrm{G}}
