...
% existing work: canonical and tucker decompositoin -> still exponential sampling complexity, only of length 3
% zeljka: projected gradient method for MPS, poly sample complexity BUT: fully gaussian measurements
% zeljka: theta bodies, analogon to nuclear norm minimization still hard for tensors -> cite
%   -> further convex relaxation
% schneider rohwedder: show that minimization converges locally
...
% also, no notion of reduced measurement for general tensors -> most natural to use products!
%
