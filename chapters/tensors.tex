...
We conclude this chapter with a lemma that shows that if all the local tensors are close in the metric used in \cref{thm:ana.local_convergence}, then the full tensors are also close in Frobenius norm up to a sign.
\begin{lemma}%
