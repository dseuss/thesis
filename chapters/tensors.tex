...
The idea of the proof of \cref{thm:ana.conditions} is as follows:
...
\begin{lemma}%
  ...
  If for $\delI \in (0, 1)$, $\prod_i \alpha_i^2 \ge 1 - \delI^2$ holds, then for any $C > 0$
  \[
    C \prod_i \alpha_i - \prod_i \sqrt{1 - \alpha_i^2} \ge C  - \delI (1 + C)
  \]
\end{lemma}
\begin{proof}
  ...
  \begin{align}
    ...
    &\ge C \sqrt{1 - \delI^2} - \delI \\
    &\ge C \left(1 - \delI\right) - \delI \\
  \end{align}
\end{proof}
