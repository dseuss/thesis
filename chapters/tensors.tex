...
\begin{proof}[Proof of \cref{thm:ana.conditions}]
  ...
  \[
    ...
    1 - \prod_{i \neq 1} \braket{x_i, y_i^0}^2 \le 1 -  \prod_{i} \braket{x_i, y_i^0}^2 \le \delI^2.
  \]
  Then, \cref{lem:ana.local_error_bound} combined with \cref{eq:ana.kappa_bound.sqrt_to_prod} yield for the normalized local update $y_1^1$ with $\Delta = \frac\delB\delG - \delI(1 + \frac\delB\delG)$
  \begin{align}
    \sqrt{1 - \Braket{x_1, y_1^1}^2}
    &\le \frac{1}{\Delta} \, \prod_{i \neq 1} \sqrt{1 - \Braket{x_i, y_i^0}^2} \\
    &\le \frac{1}{\Delta} \, \sqrt{1 - \prod_{i \neq 1} \Braket{x_i, y_i^0}^2} \\
    &\le \frac{\delI}{\Delta}.
  \end{align}
