...
The photon is coupled into and out of the photonic chip via optical fiber and all output modes are simultaneously measured by an array of single photon avalanche photodiodes.
...
Therefore, the reported errors for the HOM-dip reconstruction are minimized over $2n$ phases instead of just $n$ phases for the PhaseLift reconstruction.
