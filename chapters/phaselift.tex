...
The remaining triangular array of components colored blue in \cref{fig:experimental.schematic} is then sufficient to implement any five mode unitary transfer matrix $M$~\cite{Reck_1994_Experimental}.
...
Although performing recovery of $M$ using classical states of light
