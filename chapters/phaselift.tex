...
The crucial observation in this paper is that measurements~\eqref{eq:intensities} closely resemble the model of the \textit{phase retrieval problem}, i.e.\ the problem of recovering a complex vector ${x} \in \Complex^n$ from $m$ measurements of the form
\[
...
One practical solution to the phase retrieval problem~\cite{} -- and hence, for recovering transfer matrices -- is based on its connection to the field of low-rank matrix recovery~\cite{Ahmed_2014_Blind,Candes_2009_Exact,Candes_2011_Tight,Recht_2010_Guaranteed,Gross_2011_Recovering,Chen_2015_IncoherenceOptimal} by noting that
\[
  % y^{(l)}
