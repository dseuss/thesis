...
Especially the general proof for attentive vectors as well as the bounding-trick used in the proof for super-attentive vectors may be useful for other applications.
