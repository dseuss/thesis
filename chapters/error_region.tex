...
Therefore, in order to show that some problem is \quotes{easy}, we just have to provide a TM -- or put differently, an algorithm -- that decides that problem in polynomial time.
