...
\begin{figure*}
  ...
  \caption{\label{fig:ortho.geometry}%
    Geometric construction of a confidence region for $\varrho_0$.
    ...
    These may be unbounded if the measurements are not tomographically complete -- a drawback that can be cured by taking into account the physical constraints on quantum states, i.e.\ positive semi-definiteness.
  }
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
