...
\ifdefined\makefull\else
  \includeonly{chapters/introduction,chapters/conclusion,chapters/tensors}
...
Furthermore, in this work we propose a measurement ensemble tailored to the specific application in characterizing linear optical devices.
...
We provide evidence that a low-rank tensor $X$ can be recovered from a number of measurements that only depends on its intrinsic complexity, and hence scales polynomially in the order of tensor.
